...
const getSecurityHeaders = (isDev: boolean) => {
  ...
  const cspHeader = {
    ...
    value: isDev
      ? `default-src 'self'; connect-src 'self' http://api.compass.local:3030 http://api.compass.local:3032 ws://api.compass.local:3030 ws://api.compass.local:3032 ${API_CSP_ORIGIN ?? ''} ${WSS_CSP_ORIGIN ?? ''} https://api.open-meteo.com https://api.exchangerate-api.com https://api-maps.yandex.ru https://geocode-maps.yandex.ru https://router.project-osrm.org wss://api.compasstransfer.kg; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api-maps.yandex.ru https://yastatic.net https://*.yandex.ru; style-src 'self' 'unsafe-inline' https://unpkg.com https://yastatic.net https://*.yandex.ru; img-src 'self' data: https: https://core-renderer-tiles.maps.yandex.net https://yastatic.net https://*.maps.yandex.net https://*.yandex.ru; media-src 'self' https://www.youtube.com https://youtube.com; frame-src https://www.youtube.com https://youtube.com;`
      : `default-src 'self'; connect-src 'self' http://api.compass.local:3030 http://api.compass.local:3032 ws://api.compass.local:3030 ws://api.compass.local:3032 ${API_CSP_ORIGIN ?? ''} ${WSS_CSP_ORIGIN ?? ''} https://api.open-meteo.com https://api.exchangerate-api.com https://api-maps.yandex.ru https://geocode-maps.yandex.ru https://yastatic.net https://*.maps.yandex.net https://*.yandex.ru https://router.project-osrm.org https://api.compasstransfer.kg wss://api.compasstransfer.kg; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api-maps.yandex.ru https://yastatic.net https://*.yandex.ru; style-src 'self' 'unsafe-inline' https://unpkg.com https://yastatic.net https://*.yandex.ru; img-src 'self' data: https: https://core-renderer-tiles.maps.yandex.net https://yastatic.net https://*.maps.yandex.net https://*.yandex.ru; media-src 'self' https://www.youtube.com https://youtube.com; frame-src https://www.youtube.com https://youtube.com;`,
  };
