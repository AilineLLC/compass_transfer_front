        ...
        <div className="grid grid-cols-1 gap-2">
          ...
          {userRole !== 'partner' && sale && sale > 0 && (
            <div className="flex justify-between items-center text-green-600 border-t border-gray-100 pt-2 mt-2">
              <span className="text-sm font-medium">Скидка контрагента ({Math.round(sale * 100)}%):</span>
              <span className="font-medium">-{formatPrice(Math.max(0, fullPriceValue - totalPriceValue))}</span>
            </div>
          )}
