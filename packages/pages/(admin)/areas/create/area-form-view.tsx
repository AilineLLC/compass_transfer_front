...
import type { useAreaCreateForm } from '@features/areas/forms/create/area-create-form';
...
type AreaFormViewProps = ReturnType<typeof useAreaCreateForm>;

export function AreaFormView({
  form,
  isSubmitting,
  errors,
  watch,
      ...
      <div className='flex overflow-hidden h-full pb-2'>
                  ...
                  <div className='relative ml-12'>
                    ...
                    <div className='flex flex-col gap-2'>
                      <p className='text-sm text-muted-foreground'>
                        Выберите режим рисования: расставьте точки или нарисуйте прямоугольник. Центр (lat/lng) вычисляется автоматически.
                      </p>
        ...
        <div className='w-80 flex-shrink-0 flex flex-col h-full'>
          <FormSidebar
            ...
            chapters={AREA_FORM_CHAPTERS.CREATE}
            ...
            createButtonText='Создать область'
          />
        </div>
      </div>
    </FormProvider>
